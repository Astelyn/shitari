...
SBC:                              // Subtract with Carry
    REG_A = (BYTE)((WORD)REG_A + (operand ^ 0x00FF)
            + (WORD)(REG_S & FLAG_C));
    CALC_C(REG_A);
    CALC_Z(REG_A);
    CALC_V(REG_A);
...
/* Bitwise */
case 0x29: FETCH_IMM(); goto ; // AND IMM
case 0x25: FETCH_ZPG(); goto ; // AND ZP
case 0x35: FETCH_ZPX(); goto ; // AND ZPX
case 0x2D: FETCH_ABS(); goto ; // AND ABS
case 0x3D: FETCH_ABX(); goto ; // AND ABSX
case 0x39: FETCH_ABY(); goto ; // AND ABSY
case 0x21: FETCH_INX(); goto ; // AND INDX
case 0x31: FETCH_INY(); goto ; // AND INDY
AND:
    break;
